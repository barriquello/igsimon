...
{
    /// <summary>
    /// Classe que fornece os comandos para comunicação com o servidor web e arquivos CSV.
    /// </summary>
    class ComandosCSV
    {
        ...
        /// <param name="Data">Data do registro a salvar/carregar.</param>
        /// <returns>Nome do carquivo CSV para leitura ou gravação.</returns>
